...
/*
*  功能是:删除一个房源 涉及两个表的删除 tren trdetail
*  参数是:@param  id
*  返回值:{"status":"OK","data":{"renID":30}}
...
/*业务逻辑*/
  $sql="delete from tren where id = ".$a."";
  ...
  //继续删除相关图片的路径	  
  $sql="delete from trdetail where cid = ".$a."";
  mysqli_query($con,$sql);// 测试
  mysqli_close($con);//关闭数据库
  
  
  if($r>=1){
	  echo "{\"status\":\"OK\",\"data\":{\"renID\":".$a."}}";
	  }
  else{
